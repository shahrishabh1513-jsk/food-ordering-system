...
This project focuses on a clean **light-themed UI**, smooth user experience, and real-world food ordering flow inspired by platforms like Zomato & Swiggy.
...
* 🏠 Interactive Home Page with food sections
* 🛍️ Dynamic Add to Cart functionality
* 🧾 Multi-step Order Process (Details → Summary → Payment)
* 💳 Payment UI (UPI / Card / COD)
...
* Fully interactive **Cart System (localStorage)**
